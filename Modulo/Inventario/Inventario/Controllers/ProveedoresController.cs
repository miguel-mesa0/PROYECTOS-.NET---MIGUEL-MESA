...
namespace Inventario.Controllers
{
    ...
    public class ProveedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,NIT,Telefono,Email,Direccion")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,NIT,Telefono,Email,Direccion")] Proveedore proveedore)
        {
            if (id != proveedore.Id)
            {
                return NotFound();
